    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='chats.Chat', verbose_name='Чат')),
                ('last_read_message', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='chats.Message', verbose_name='Последнее прочитанное')),
